...
CREATE TABLE `persontype` (
  ...
  `persontypeName` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`persontypeId`),
  CONSTRAINT `persontype` FOREIGN KEY (`persontypeId`) REFERENCES `person` (`persontypeId`)
...
INSERT INTO `persontype` VALUES (1,'Staff'),(2,'Faculty'),(3,'Student');
